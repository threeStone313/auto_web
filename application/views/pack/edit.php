<div class="row">
	...
	<article class="col-sm-12">
		<div class="data-block">
			<header>
				<h2><span class="elusive icon-calendar"></span> Edit a pack</h2>
			...
			<section class="tab-content">
				...
				<div id="horizontal" class="tab-pane active">
					...
					<?php echo form_open( 'pack/update/'.$data['id'], array('role'=>'form', 'class'=>'form-horizontal')); ?>
						<?php echo $notice;?>
						<div class="form-group">
							<label class="col-sm-2 control-label" >Pack Name</label>
							<div class="col-sm-5">
								<input type="text" placeholder="" class="form-control" name="name" value="<?php echo $data['name'];?>">
							</div>
						</div>
						<div class="form-group">
